    ...
    <>
      <div className='grid md:grid-cols-5'>
        <div className="md:col-span-3 p-8 m-auto">
          ...
          <p className="pt-10">
            I'm a backend Java developer at IBM in Austin, TX. I love to learn new technologies and build intresting projects. I enjoy running, playing the guitar, and travel photography.
          </p>
        </div>

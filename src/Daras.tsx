function Contact() {
  ...
  return (
    <>
        <div className="py-16">
          <h1 className="text-7xl font-bold text-center">Daras Privacy Policy</h1>
          <div className="p-16">
            <strong>Privacy Policy</strong>
            <p>This privacy policy applies to the Daras app (hereby referred to as "Application") for mobile devices that was created by Ralph Sanders (hereby referred to as "Service Provider") as a Free service. This service is intended for use "AS IS".</p>
            <br></br>
            ...
            <ul className="">
              <li className="list-inside list-disc">Your device's Internet Protocol address (e.g. IP address)</li>
              <li className="list-inside list-disc">The pages of the Application that you visit, the time and date of your visit, the time spent on those pages</li>
              <li className="list-inside list-disc">The time spent on the Application</li>
              <li className="list-inside list-disc">The operating system you use on your mobile device</li>
            </ul>
            <p></p>
            <br></br>
            ...
            <div>
              ...
              <ul>
                <li className="list-inside list-disc"><a href="https://www.google.com/policies/privacy/" target="_blank" rel="noopener noreferrer">Google Play Services</a></li>
              </ul>
            </div>
            <br></br>
            <p>The Service Provider may disclose User Provided and Automatically Collected Information:</p>
            <ul>
              <li className="list-inside list-disc">as required by law, such as to comply with a subpoena, or similar legal process;</li>
              <li className="list-inside list-disc">when they believe in good faith that disclosure is necessary to protect their rights, protect your safety or the safety of others, investigate fraud, or respond to a government request;</li>
              <li className="list-inside list-disc">with their trusted services providers who work on their behalf, do not have an independent use of the information we disclose to them, and have agreed to adhere to the rules set forth in this privacy statement.</li>
            </ul>
            <p></p>
            <br></br>
            ...
            <p>The Service Provider will retain User Provided data for as long as you use the Application and for a reasonable time thereafter. If you'd like them to delete User Provided Data that you have provided via the Application, please contact them at rlsanders4@gmail.com and they will respond in a reasonable time.</p>
            <br></br>
            ...
            <br></br>
            <p>This privacy policy is effective as of 2024-04-10</p>
            <br></br>
            ...
            <p>If you have any questions regarding privacy while using the Application, or have questions about the practices, please contact the Service Provider via email at rlsanders4@gmail.com.</p>
            <hr></hr>

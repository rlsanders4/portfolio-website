      ...
      <nav className="flex items-center justify-between flex-wrap p-6">
        ...
        <div className={mobileMenuOpen ? "bg-black fixed w-full h-full top-0 left-0 z-10 flex flex-col m-0 center justify-evenly items-center" : "hidden" }>
          ...
          <div className="flex flex-col items-center justify-between min-h-[200px]">
            ...
            <NavLink to="/contact-me" className={({isActive}) => [ isActive ? "underline" : "" ]
                + " block mt-4 hover:underline decoration-2 underline-offset-8"}>
                Contact Me
            </NavLink>
            <a href="https://www.linkedin.com/in/ralph-sanders-3b1704177" target="_blank" rel="noopener noreferrer" className="inline-block mt-4">
